...
public class HttpServerExchangeStub {
    ...
    public static HttpServerExchange createHttpExchange(String queryString) throws IOException {
        ...
        return createHttpExchange(connection, headerMap, queryString);
    }

    private static StreamConnection createStreamConnection() throws IOException {
    ...
    private static HttpServerExchange createHttpExchange(ServerConnection connection, HeaderMap headerMap, String queryString) {
        ...
        httpServerExchange.setQueryString(queryString);
